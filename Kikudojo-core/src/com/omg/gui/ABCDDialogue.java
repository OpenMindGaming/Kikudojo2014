...
public class ABCDDialogue extends Table {
	...
	public ABCDDialogue(QRBlock block, SoundManager sM) {
		...
		replaySoundButton = new JSButton("","HUD_Q_Replay");
		replaySoundButton.setPosition(-1150, -75);
		replaySoundButton.setScale(.75f);
		replaySoundButton.setButtonEvent(new ButtonEvent() {
			...
			public void onPress() {
				...
				soundManager.play(qrBlock.getQuestionSound());
